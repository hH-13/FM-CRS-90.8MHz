//scrolly shit
window.onscroll = function() {navy()};
var navbar = document.getElementById("mynav");
var contentH = (document.getElementById("mysite").offsetTop - 150);
...
function myFunction() {
  ...
  if ( (x.className === "nav") || (x.className === "nav opaq") ) {
...
//eventy shit
$(function() {
        $('.card_events > .action-btn_events').click(function () {
            var card = $(this).parent('.card_events');
            var icon = $(this).children('i');
            icon.addClass('fa-spin-fast');

            if (card.hasClass('card-active_events')) {
                card.removeClass('card-active_events');
                ...
                card.addClass('card-active_events');
